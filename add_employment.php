      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="row">
             ...
             <div class="box-header with-border">
<h3 class="box-title"> 
<a onclick="back()"><i class="fa fa-arrow-left"></i><b>Employment opportunity</b></a>
</h3>
                </div><!-- /.box-header -->
                </div><!-- /.box-header -->
                <!-- form start -->
...
<div class="col-md-6">
 ...
 <div class="form-group">
  ...
  <input type="text" name ="employement" class="form-control">
  </div>

<div class="box-footer">
<button type="submit" name="action" value="add-employement" class="btn btn-primary">Submit</button>
  </div>
</div> 
</div>
</form>
