...
<a href="add_categories.php" style="float:right"><button class="btn btn-primary">Add Categories</button></a>
</div>	
<div class="box-body">
<?php 
...
<input type="hidden" name="category_image" value="<?=$cat['catagory_image']?>">
...
<td>
<a href="edit_category.php?category_id=<?=$cat['category_id']?>" class="btn btn-primary">Edit</a>

<a href="delete_controller.php?action=deleteCat&category_id=<?=$cat['category_id']?>&category_image=<?=$cat['category_image']?>"  class="btn btn-primary">Delete</a>
