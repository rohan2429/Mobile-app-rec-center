...
$query ="select * from gu_gallery where gallery_id=$gallery_id";
...
<label>Gallery type</label>
 <input type="text" class="form-control" name="type" value="<?=$cat['type']?>" readonly />
 </div>
 <div class="form-group">
<label>Title</label>
...
<button type="submit" name="action" value="gallery" class="btn btn-primary">Submit</button>
  </div>
  <?php
}
 }?>
