...
<label>Hours Of Operation</label>
 <input type="text" class="form-control" name="operation" placeholder="Enter Hours Of Operation" required />
 </div>	
...
<button type="submit" name="action" value="hours-operation" class="btn btn-primary">Submit</button>
  </div>
</div> 
</div>
</form>
