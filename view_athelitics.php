...
Atheletics
<small>Atheletics Detailes tables</small>
</h1>
<ol class="breadcrumb">
<li><a href="#"><i class="fa fa-dashboard"></i>Atheletics</a></li>
</ol>
</section>
<!-- Main content -->
...
<a href="add_athelitics.php" style="float:right"><button class="btn btn-primary">Add Atheletics</button></a>
</div>	
<div class="box-body">
<?php 
...
$query ="select * from gu_atheletics" ;
$rowCount=mysql_query($query);
 if($rowCount > 0){
while($cat= mysql_fetch_assoc($rowCount)){	 
?>	 
<tr>
<input type="hidden" name="atheletic_id" value="<?=$cat['atheletic_id']?>">
<td>
<?=$cat['atheletics_name']?></span>
</td>
<td>
<video width="200" height="200" controls>
  <source src="<?=$cat['video_path']?>">
</video>
</td>

<td>

<a href="delete_controller.php?action=deleteAtheletic&atheletic_id=<?=$cat['atheletic_id']?>&video_path=<?=$cat['video_path']?>"  class="btn btn-primary">Delete</a>
</td>
</tr>
<?php 
