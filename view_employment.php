...
Employement
<small>Employement Detailes tables</small>
</h1>
<ol class="breadcrumb">
<li><a href="#"><i class="fa fa-dashboard"></i>Employement</a></li>
</ol>
</section>
<!-- Main content -->
...
<a href="add_employment.php" style="float:right"><button class="btn btn-primary">Add Employment</button></a>
</div>	
<div class="box-body">
<?php 
...
$query ="select * from gu_employement" ;
...
<input type="hidden" name="employment_id" value="<?=$cat['employment_id']?>">
<td>
<span>
...
<a href="delete_controller.php?action=deleteEmployment&employment_id=<?=$cat['employment_id']?>"  class="btn btn-primary">Delete</a>
<a href="view_jobs.php?employment_id=<?=$cat['employment_id']?>" class="btn btn-primary">View Jobs</a>
</td>
</tr>
<?php 
$i++;
