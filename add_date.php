...
?>
<input type="hidden" name="groupfitnes_id" value="<?=$groupfitnes_id?>">

 <div class="form-group">
<label>TITLE</label>
 <input type="text" class="form-control" name="groupfitness_title" value="<?=$cat['groupfitness_title']?>" readonly>
 </div>
  <div class="form-group">
<label>Date</label>
...
<button type="submit" name="action" value="add_date" class="btn btn-primary">Submit</button>
  </div> 
</div>
</form>
