...
<label>Group Fitness Title</label>
 <input type="text" class="form-control" name="groupfitnessTitle" placeholder="Enter Title" required />
 </div>	
...
<button type="submit" name="action" value="add-groupfitness" class="btn btn-primary">Submit</button>
  </div>
</div> 
</div>
</form>
