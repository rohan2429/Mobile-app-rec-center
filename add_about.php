      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="row">
             ...
             <div class="box-header with-border">
<h3 class="box-title"> 
<a onclick="back()"><i class="fa fa-arrow-left"></i><b>About Sub Categories</b></a>
</h3>
                </div><!-- /.box-header -->
                </div><!-- /.box-header -->
                <!-- form start -->
...
<label>Sub Catagory</label>
 ...
 <div class="form-group">
<label>Choose Document Extensions(pdf,xls,doc)</label>
...
<button type="submit" name="action" value="add-about" class="btn btn-primary">Submit</button>
  </div>
</div> 
</div>
</form>
