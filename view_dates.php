...
Dates
<small><span>Dates Detailes tables</small>
</h1>
<ol class="breadcrumb">
...
<h3 class="box-title"> 
<a onclick="back();"><i class="fa fa-arrow-left"></i><b>Dates List</b></a>
</h3></br></br>
<?php
$groupfitnes_id=$_REQUEST['groupfitnes_id'];
?>
<a href="add_date.php?groupfitnes_id=<?=$groupfitnes_id?>" style="float:right"><button class="btn btn-primary">Add Dates</button></a>
</div>	
<div class="box-body">
<?php 
...
$groupfitnes_id=$_REQUEST['groupfitnes_id'];
$query ="select * from events_dates where groupfitnes_id=$groupfitnes_id" ;
...
<a href="delete_controller.php?action=deleteDates&event_date_id=<?=$cat['event_date_id']?>&groupfitnes_id=<?=$cat['groupfitnes_id']?>"  class="btn btn-primary">Delete</a>
