...
<label>Categorie ID</label>
 <input type="text" class="form-control" name="category_id" placeholder="Enter Categories ID" required />
 </div>	-->
 <div class="form-group">
<label>Catagory Name</label>
 <input type="text" class="form-control" name="categoryName" placeholder="Enter catagory name" required />
 </div>	
...
<button type="submit" name="action" value="category" class="btn btn-primary">Submit</button>
  </div>
</div> 
</div>
</form>
